 ...
 */
static char font[] = "Meslo LG S for Powerline:pixelsize=15:antialias=true:autohint=true";
//static char font[] = "Fira Mono for Powerline:style=Regular:pixelsize=16:antialias=true:autohint=true";
